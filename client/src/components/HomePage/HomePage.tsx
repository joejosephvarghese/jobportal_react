...
function HomePage() {
  ...
  return (
    <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
      <img
        src="https://img.freepik.com/free-vector/dark-hexagonal-background-with-gradient-color_79603-1409.jpg?w=1060&t=st=1692267518~exp=1692268118~hmac=7b2a7e02494efcad99cd5682d064e9f105dd7b5481ee85198db33cefcd8853bb"
        alt=""
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-100 max-w-2xl lg:mx-0 lg:max-w-none">

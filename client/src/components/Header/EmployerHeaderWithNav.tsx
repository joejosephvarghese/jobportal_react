...
import { clearEmployerToken } from "../../features/redux/slice/employer/employerTokenSlice";
import { employerLogout } from "../../features/redux/slice/employer/employerDetailsSlice";
import {
  Navbar,
  Typography,
  Button,

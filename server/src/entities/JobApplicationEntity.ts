...
import { User } from "../frameworkes/database/models/userModel";
import { Job } from "../frameworkes/database/models/jobModel";
import { Employer } from "../frameworkes/database/models/employerModel";
